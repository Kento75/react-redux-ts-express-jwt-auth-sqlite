...
Object.defineProperty(exports, "__esModule", { value: true });
var React = __webpack_require__(/*! react */ "./node_modules/react/index.js");
var AddTodoButton_1 = __webpack_require__(/*! ./containers/AddTodoButton */ "./src/containers/AddTodoButton.ts");
var TodoList_1 = __webpack_require__(/*! ./containers/TodoList */ "./src/containers/TodoList.ts");
var app = function () {
    return (React.createElement("div", null,
        React.createElement(AddTodoButton_1.default, null),
...
var nextTodoId = 0;
var TodoActionType;
(function (TodoActionType) {
    TodoActionType["ADD_TODO"] = "ADD_TODO";
    TodoActionType["TOGGLE_TODO"] = "TOGGLE_TODO";
})(TodoActionType = exports.TodoActionType || (exports.TodoActionType = {}));
/**
 * TODO追加アクション
 * @param text 入力値
 */
...
var AddButton = /** @class */ (function (_super) {
    ...
    function AddButton(props) {
        ...
        _this.onFormSubmit = function (e) {
            e.preventDefault();
            if (!_this.state.input.trim()) {
                return;
            }
            _this.props.onSubmit(_this.state.input);
            _this.setState({
                input: "",
            });
        };
    ...
    AddButton.prototype.render = function () {
        return (React.createElement("div", null,
            React.createElement("form", { onSubmit: this.onFormSubmit },
                React.createElement("input", { value: this.state.input, onChange: this.onInputChange }),
...
var Todo = /** @class */ (function (_super) {
    ...
    Todo.prototype.render = function () {
        var _a = this.props, completed = _a.completed, text = _a.text, onClick = _a.onClick;
...
var TodoList = /** @class */ (function (_super) {
    ...
    TodoList.prototype.render = function () {
        ...
        return (React.createElement("ul", null, todos.map(function (todo) { return (React.createElement(Todo_1.default, __assign({ key: todo.id }, todo, { onClick: function () { return onTodoClick(todo.id); } }))); })));
    };
    return TodoList;
}(React.Component));
...
var AddTodoButton_1 = __webpack_require__(/*! ../components/AddTodoButton */ "./src/components/AddTodoButton.tsx");
...
var mapDispatchToProps = function (dispatch) {
    return {
        onSubmit: function (s) {
            dispatch(actions_1.addTodo(s));
        },
    };
};
exports.default = react_redux_1.connect(mapStateToProps, mapDispatchToProps)(AddTodoButton_1.default);
...
var react_redux_1 = __webpack_require__(/*! react-redux */ "./node_modules/react-redux/es/index.js");
var actions_1 = __webpack_require__(/*! ../actions */ "./src/actions/index.ts");
var TodoList_1 = __webpack_require__(/*! ../components/TodoList */ "./src/components/TodoList.tsx");
var mapStateToProps = function (state) {
    return {
        todos: state,
    };
...
var todos_1 = __webpack_require__(/*! ./reducers/todos */ "./src/reducers/todos.ts");
var App_1 = __webpack_require__(/*! ./App */ "./src/App.tsx");
var store = redux_1.createStore(todos_1.default, []);
...
var todos = function (state, action) {
    switch (action.type) {
        case actions_1.TodoActionType.ADD_TODO:
            return state.concat([
                {
                    completed: false,
                    id: action.id,
        ...
        case actions_1.TodoActionType.TOGGLE_TODO:
            return state.map(function (todo) { return (todo.id === action.id) ? __assign({}, todo, { completed: !todo.completed }) : todo; });
        default:
            return state;
    }
};
